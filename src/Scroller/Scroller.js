...
class Scroller {
  ...
  computeScrollOffset() {
    ...
    let timePassed = currentAnimationTimeMillis() - this.mStartTime;
    ...
    let dx = this.mCurrX - this.mLastX;
    let dy = this.mCurrY - this.mLastY;
  ...
  getSplineFlingDuration(velocity) {
    ...
    let decelMinusOne = DECELERATION_RATE - 1.0;
