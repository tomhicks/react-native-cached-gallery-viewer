...
import {ListView, Platform, View, ViewPropTypes} from 'react-native';

import Scroller from '../Scroller/Scroller';
import createResponder from '../GestureResponder/createResponder';
...
class ViewPager extends Component {
  ...
  render() {
    ...
    return (
      <View {...this.props} style={[this.props.style, {flex: 1}]} {...gestureResponder}>
        <ListView
          style={{flex: 1}}
          ref="innerListView"
          scrollEnabled={false}
  ...
  scrollToPage(page, immediate) {
    ...
    const finalX = this.getScrollOffsetOfPage(page);
    this.scroller.startScroll(this.scroller.getCurrX(), 0, finalX - this.scroller.getCurrX(), 0, immediate ? 0 : 400);
  }
